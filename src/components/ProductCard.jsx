...
return (
    ...
    <article className="flex w-full max-w-80 flex-col gap-5 rounded-lg border-3 border-gray-400 p-6">
        ...
        <button type="button" className="rounded-md bg-amber-500 px-4 py-2 font-semibold text-white hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2" onClick={addToCart} >Add to Cart</button>
